...
Example to get posts with the following curl command:

```bash
curl --location 'http://localhost:8080/api/posts?direction=desc&sortBy=reads&authorIds=2' \
--header 'x-access-token: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNzA2MDc5OTY5LCJleHAiOjE3MDYxNjYzNjl9.G9ceQkL_VuFhL2ySUIMQDeVlpW9HQ2_c7qsfjB-5_08'
```
